        ...
        StreamBuilder(
          ...
          builder: (context, snapshot){
            ...
            Container(
              ...
              child: Center(child: Text("No user chat Found",style: TextStyle(
            ...
            Container(
              ...
              child: PaginatedDataTable(
                  header: TextWidget(text: "Total User Chat: ${snapshot.data!.docs.length}",size: 20,color: Colors.white, isBold: false,),
                  ...
                  columns: const [
                    DataColumn(label: TextWidget(text: "Username", color: Colors.black,
...
class DataTableSourceImpl extends DataTableSource {
  ...
  DataRow? getRow(int index) {
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          TextWidget(text: category[index][Constant.KEY_USERNAME].toString(), color: Colors.white,
            ...
            Row(
              children: [
                Container(
                  ...
                  child: const Center(child: Icon(Icons.supervised_user_circle)),
                ),
                Padding(
        ...
        DataCell(
          TextWidget(text: category[index][Constant.KEY_EMAIL].toString(), color: Colors.white,
            size: 14.0, isBold: false,),
        ),
            ...
            Row(
              children: [
                ...
                GestureDetector(
                    onTap: (){
                      Provider.of<MenuAppController>(context,listen: false)
                          .changeScreenWithParams(Routes.CHAT_DETAILS, parameters: {
                        Constant.KEY_USERUID.toString():category[index][Constant.KEY_USERUID].toString(),
                        Constant.KEY_EMAIL.toString():category[index][Constant.KEY_EMAIL].toString(),
                        Constant.KEY_FULLNAME.toString():category[index][Constant.KEY_FULLNAME].toString(),
                        Constant.KEY_USERNAME.toString():category[index][Constant.KEY_USERNAME].toString(),

                      });
                    },
                    child: Icon(Icons.chat,color: Colors.orange,size: Responsive.isMobile(context) ? 24 : 30,)),
              ],)
        ),
      ],
    );
