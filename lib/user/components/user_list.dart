          ...
          builder: (context, snapshot){
            ...
            Container(
              ...
              child: PaginatedDataTable(
                  header: TextWidget(text: "Total Users: ${snapshot.data!.docs.length}",size: 20,color: Colors.white, isBold: false,),
                  ...
                  columns: const [
                    ...
                    DataColumn(label: TextWidget(text: "Email", color:  Colors.black,
                      size: 14.0, isBold: true,),),
                    DataColumn(label: TextWidget(text: "Create Date", color:  Colors.black,
                      size: 14.0, isBold: true,),),
            ...
            Row(
              children: [
                ...
                GestureDetector(
                    onTap: (){
                      Provider.of<MenuAppController>(context,listen: false)
                          .changeScreenWithParams(Routes.USER_LOGIN_HISTORY_SCREEN, parameters: {
