...
class WithdrawList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        StreamBuilder(
          stream: firestore.collection(Constant.COLLECTION_WITHDRAW)
          ...
          builder: (context, snapshot){
            ...
            Container(
              ...
              child: Center(child: Text("No withdraw Found",style: TextStyle(
            ...
            Container(
              ...
              child: PaginatedDataTable(
                  header: TextWidget(text: "Total Withdraw: ${snapshot.data!.docs.length}",size: 20,color: Colors.white, isBold: false,),
